...
if response.status_code == 200:
    ...
    df_data["longitude"], df_data["latitude"] = transform(
        in_proj, out_proj, df_data["x_l93"].values, df_data["y_l93"].values
    )
...
for polluant in polluants:
    ...
    filt_data = df_data[
        (df_data["nom_com"] == "MONTPELLIER") & (df_data["nom_poll"] == polluant)
    ]
