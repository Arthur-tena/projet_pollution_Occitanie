...
for polluant in polluants:
    ...
    filt_data = df[(df['nom_dept'] == 'HAUTE-PYRENEES') & (df['nom_poll'] == polluant)]
...
for polluant in polluants:
    fig = px.scatter(filt_data[filt_data['nom_poll'] == polluant], x='date_debut', y='valeur', 
                  title=f'Évolution de {polluant} au fil du temps dans le département Haute-Pyrénées',
