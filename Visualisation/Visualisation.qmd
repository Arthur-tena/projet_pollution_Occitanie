...
num_cols = 4
num_rows=3
fig, axes = plt.subplots(nrows=num_rows, ncols=num_cols, figsize=(7.5, 6))
...
Nous remarquons que les polluants que l'on mesure le plus dans l'Occitanie sont l'O3, le PM10 et le PM2.5, ce qui rentre en conflit avec ce que l'on avait observé avec les camenberts du graphique précédent. 
