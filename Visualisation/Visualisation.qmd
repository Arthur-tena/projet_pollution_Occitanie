...
import pandas as pd
import matplotlib.pyplot as plt
def plot_pollutants_by_year(csv_file):
...
plot_pollutants_by_year("/Users/arthurtena/Documents/data/Mesure_annuelle_Region_Occitanie_Polluants_Principaux.csv")
```
...
fig.update_layout(
    ...
    title="Polluants en fonction de l'année en Occitanie",
    showlegend=True,
