...
if response.status_code == 200:
    ...
    polluants = ['O3', 'PM10', 'NO2','PM2.5']
    # Boucle à travers les polluants pour créer les graphiques
for polluant in polluants:
    #Regrouper les données de la ville de Nimes
    filt_data = df_data[(df_data['nom_com'] == 'NIMES') & (df_data['nom_poll'] == polluant)]
    ...
    fig = px.scatter(
        ...
        title=f'Évolution de la pollution {polluant} à Nimes',
